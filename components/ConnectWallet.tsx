...
const ConnectButton = ({
	...
	return (
		<div className="buttons">
			<Button color="secondary" variant="outlined" className="button" onClick={connectWallet}>
				<span>
					<i className="fas fa-wallet"></i>&nbsp; Connect with wallet
				</span>
			</Button>
			<Button color="secondary" variant="outlined" className="button" disabled={loadingNano} onClick={connectNano}>
				{loadingNano ? (
					<span>
